                        ...
                        <div className="col-lg-6 col-md-12 col-xl-7">
                            <div className="block">
                                ...
                                <div className="btn-container ">
                                    <Link to="/appointment" className="btn btn-main-2 btn-icon btn-round-full">Make appoinment <i className="icofont-simple-right ml-2  "></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-lg-6 col-md-10 ">
                            <div className="appoinment-wrap mt-5 mt-lg-0">
                                ...
                                <form id="#" className="appoinment-form" method="post" action="#">
                                    ...
                                    <a href className="btn btn-main btn-round-full" >Make Appointment <i className="icofont-simple-right ml-2  "></i></a>
                                </form>
                            </div>
                        </div>
                    </div>
