                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12">
                            <form id="contact-form" className="contact__form" method="POST" action="http://localhost/doctor_admin/New/Api/contact.php">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="form-group">
                                            <input name="mobile" id="phone" type="text" className="form-control" placeholder="Your Phone Number" required />
                                        </div>
                                    </div>
                                </div>
